...
import { IconButton, Box, Typography, useTheme, Button, Divider, TextField, InputAdornment } from '@mui/material';
...
export const Product = ({ item, width }) => {
  ...
  console.log("🚀 ~ file: Product.jsx:23 ~ Product ~ image:", image)
  const {
    data: {
      attributes: {
        formats: {
